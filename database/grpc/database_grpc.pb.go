...
type DatabaseHelperClient interface {
	...
	DeleteRow(ctx context.Context, in *DeleteRowRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *databaseHelperClient) DeleteRow(ctx context.Context, in *DeleteRowRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/database.DatabaseHelper/DeleteRow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DatabaseHelperServer interface {
	...
	DeleteRow(context.Context, *DeleteRowRequest) (*Response, error)
...
func (UnimplementedDatabaseHelperServer) DeleteRow(context.Context, *DeleteRowRequest) (*Response, error) {
...
func _DatabaseHelper_DeleteRow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteRowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DatabaseHelperServer).DeleteRow(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/database.DatabaseHelper/DeleteRow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DatabaseHelperServer).DeleteRow(ctx, req.(*DeleteRowRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DatabaseHelper_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DatabaseHelper_DeleteRow_Handler,
		},
		{
			MethodName: "Query",
